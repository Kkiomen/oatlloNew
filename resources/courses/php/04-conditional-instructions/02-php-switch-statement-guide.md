...
1. Complete the switch so that 'jpg' and 'jpeg' print “JPEG image”, 'png' → “PNG image”, and others → “Unknown format”.
2. Is there a logical bug here?
...
1. Which is safer for strict comparisons and returning values: switch or match? ➡️ match
2. Write a `switch(true)` that classifies temperature:
