...
1. Correct way to iterate by index? ➡️ `for ($i = 0; $i < count($a); $i++)`
2. Output?
...
1. Which is true? ➡️ Condition is checked before each iteration.
2. Error here?
...
1. Fill blank for 10 iterations: ➡️ `$i <= 10`
2. Output?
...
1. True/False: All three for sections can be empty. ➡️ True
