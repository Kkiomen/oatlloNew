...
1. What’s the difference between while and do-while? ➡️ do-while runs body at least once, while may not run at all.
2. Which syntax is correct? ➡️ `do { ... } while ($x > 0);`
3. How to safely break from infinite do-while? ➡️ Use break with condition or attempt limit.
4. When is do-while better than while? ➡️ When code must run at least once (prompt, menu).
5. What’s wrong here?
...
1. True/False: The semicolon after while condition is optional. ➡️ False – it’s required.
