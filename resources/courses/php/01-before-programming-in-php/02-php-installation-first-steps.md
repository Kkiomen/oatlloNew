...
- or in some versions: /Applications/XAMPP/xamppfiles/htdocs In the XAMPP manager, the “Explore”/“Open Application Folder” button will take you directly to htdocs.
...
- Don’t open PHP files via double-click or file:/// path — PHP won’t execute. Always use [http://localhost/…](http://localhost/%E2%80%A6)
...
1. Where do you place your project files in XAMPP to run them at [http://localhost/](http://localhost/)?

- a) In any Desktop folder
- b) In the htdocs directory
- c) In the Documents folder

1. What address do you enter to run the folder my_project located in htdocs?
...
1. What do you do if Apache can’t start because port 80 is busy?
