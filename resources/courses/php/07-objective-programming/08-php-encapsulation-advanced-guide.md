...
1. What is the main goal of encapsulation in PHP OOP? ➡️ Hide implementation and protect state.
2. Which modifier hides implementation most strongly? ➡️ private.
3. Why are raw setters harmful? ➡️ Allow uncontrolled state changes without validation.
4. Best type for money? ➡️ int (smallest unit, e.g., cents).
5. What does readonly mean in PHP 8.1+? ➡️ Property cannot be changed after construction.
6. How to change internal representation safely? ➡️ Keep a stable public API, hide implementation.
