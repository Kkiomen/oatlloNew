...
<footer class="border-t border-white/5 bg-neutral-950">
    <div class="mx-auto max-w-7xl px-6 py-14 lg:px-8">
            ...
            <div class="grid grid-cols-2 gap-10">
                <div>
                    ...
                    <ul class="mt-4 space-y-2 text-sm text-neutral-400">
                        <li><a href="{{ route('index') }}" class="hover:text-emerald-400">{{ __('basic.home') }}</a></li>
                        <li><a href="{{ route('blog') }}" class="hover:text-emerald-400">Blog</a></li>
                        <li><a href="{{ \App\Services\HomeService::getRouteCourses() }}" class="hover:text-emerald-400">{{ __('basic.courses') }}</a></li>
                    </ul>
                </div>
                <div>
                    <h2 class="text-sm font-semibold text-white">Connect</h2>
                    <ul class="mt-4 space-y-2 text-sm text-neutral-400">
                        <li><a href="https://www.linkedin.com/in/jakub-owsianka-446bb5213/" target="_blank" rel="noopener" class="hover:text-emerald-400">LinkedIn</a></li>
                        <li><a href="{{ route('feed') }}" class="hover:text-emerald-400">RSS</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/5 pt-8 sm:flex-row">
            ...
            <a href="{{ $course->getRoute() }}" class="text-sm text-neutral-400 hover:text-emerald-400"><i class="fa-solid fa-arrow-left mr-1"></i> {{ $course->title_list ?: $course->name }}</a>
        </div>
    </div>
</footer>
