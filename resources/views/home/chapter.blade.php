    ...
    <div class="bg-gray-900" x-data="{ open: true }">
        ...
        <div class="relative isolate pt-14 bg-gray-800 py-24 sm:py-32">
            <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl pt-14 md:pt-0 lg:px-8">
                ...
                <h2 class="text-base/7 font-semibold text-white mt-3">{!! $course->description_full !!}</h2>
            </div>
        </div>
                                            ...
                                            <div class="relative flex items-start space-x-3">
                                                ...
                                                <div class="min-w-0 flex-1 py-0">
                                                    <div class="text-sm/8 text-gray-500">
                                                        <div class="mr-0.5">
                                                            <h3>
                                                                <a href="{{ $category->getRoute() }}" class="font-medium text-lg text-gray-900 hover:text-gray-700 hover:underline">{{ $category->title }}</a>
                                                                <span class="ml-2">
                                                        ...
                                                        <div class="mt-4">
                                                            @foreach($category->lessons as $lesson)
                                                                <div class="py-1">
                                                                    <h4><a href="{{ $lesson->getRoute() }}" class="font-medium text-gray-900 hover:text-blue-600">{{ $lesson->title }}</a></h4>
                                                                    {{ $lesson->seo_description ?: 'Lekcja kursu' }}
                                                                </div>
