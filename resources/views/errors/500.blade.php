...
<head>
    ...
    <title>500 – Błąd serwera | Oatllo</title>
    <meta name="description" content="Wystąpił błąd serwera (500).">
...
<style>
        ...
        .glow { background: radial-gradient(50% 50% at 50% 40%, rgba(245,158,11,.16) 0%, rgba(245,158,11,0) 70%); }
        .grid-mask {
...
<div class="relative isolate flex min-h-screen flex-col">
    ...
    <main class="mx-auto flex w-full max-w-2xl flex-1 flex-col items-center justify-center px-6 text-center">
        ...
        <div class="mt-10 flex flex-wrap items-center justify-center gap-4">
            <a href="{{ route('index') }}" class="inline-flex items-center gap-2 rounded-xl bg-amber-500 px-6 py-3.5 text-base font-semibold text-neutral-950 shadow-lg shadow-amber-500/30 hover:bg-amber-400 transition-colors duration-200">
