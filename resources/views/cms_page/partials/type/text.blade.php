<div class="mt-3 border p-3 border-gray-300 rounded-xl">
    ...
    <div class="mt-5">
        ...
        @elseif($element['type'] == 'textarea')
            ...
            <div class="mt-2">
                <textarea rows="4" name="{{ $element['key'] }}0001000" id="{{ $element['key'] }}0001000" class="block w-full p-3 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{ $element['value'] }}</textarea>
            </div>
        @endif
    </div>
