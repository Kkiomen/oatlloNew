...
Start with the polling relay. It's the version you can read top to bottom and fix at 3am. Add the dedup table on your consumers before you ship, not after your first duplicate charge. Graduate to Debezium only when the numbers or your existing stack make it the obvious choice - and when you do, put a pruning job on the calendar the same day.
